...
class AmangClient(TelegramClient):
    def __init__(
        self,
        session,
        api_id=None,
    ...
    async def fast_uploader(self, file, **kwargs):
        ...
        from Amang.fns.FastTelethon import upload_file
        from Amang.fns.helper import progress
    ...
    async def fast_downloader(self, file, **kwargs):
        ...
        from Amang.fns.FastTelethon import download_file
        from Amang.fns.helper import progress
