...
from .. import LOGS, asst, udB, amang_bot
from ..fns.admins import admin_check
from . import append_or_update, owner_and_sudos

OWNER = amang_bot.full_name
...
IN_BTTS = [
    [
        Button.url(
            "Repository",
            url="https://github.com/amangtele/AmangUserbot",
        ),
        Button.url("Support", url="https://t.me/purapuranyagcsupport"),
    ]
]
...
def callback(data=None, from_users=[], admins=False, owner=False, **kwargs):
    ...
    if "me" in from_users:
        ...
        from_users.append(amang_bot.uid)
