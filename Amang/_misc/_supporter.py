...
from Amang._misc._decorators import compile_pattern, amang_cmd
...
ALIVE_NAME = amang_bot.me.first_name
BOTLOG_CHATID = BOTLOG = udB.get_key("LOG_CHANNEL")


bot = borg = catub = friday = amang_bot
catub.cat_cmd = amang_cmd
...
class Config((object)):
    if ENV:
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Amang")
