...
from . import amang_cmd, get_string, HNDLR, async_searcher


@amang_cmd(pattern="joke$")
async def _(ult):
    await ult.eor(get_joke())


@amang_cmd(pattern="url ?(.*)")
async def _(event):
