...
@amang_cmd(outgoing=True, pattern="ngentot")
async def _(event):
...
@amang_cmd(outgoing=True, pattern="goblok")
async def _(event):
...
@amang_cmd(outgoing=True, pattern="ngatain")
async def _(event):
...
@amang_cmd(outgoing=True, pattern="yatim")
async def _(event):
...
@amang_cmd(outgoing=True, pattern="kont")
async def _(event):
