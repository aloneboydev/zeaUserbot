...
from Amang._misc._decorators import amang_cmd, compile_pattern
...
from Amang.fns.misc import *
from Amang.fns.tools import *
from Amang.version import amang_version, __version__ as AmangVer
...
def inline_pic():
    ...
    if INLINE_PIC is None:
        INLINE_PIC = choice(AMANG_IMAGES)
