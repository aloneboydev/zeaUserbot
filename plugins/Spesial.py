...
from Amang.fns.google_image import googleimagesdownload
from Amang.fns.tools import metadata
...
@amang_cmd(pattern="q( (.*)|$)", manager=True, allow_pm=True)
async def quott_(event):
    ...
    message = await reply.reply("Quotly by Amang", file=file)
    os.remove(file)
    await msg.delete()
    return message
